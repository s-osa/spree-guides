...
> Flexible rate: Flat rate for the first product + Flat rate for each
> additional product.
...
As an example of how to use the active\_shipping extension we’ll
...
As you can see in the code above, the active\_shipping gem returns an
